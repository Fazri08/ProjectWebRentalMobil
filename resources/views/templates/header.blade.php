...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ asset('assets') }}/index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Se</b>Yu</span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ asset('/merk') }}"><i class="fa fa-book text-success"></i> <span>Merk</span></a></li>
        <li><a href="{{ asset('/mobil') }}"><i class="fa fa-book text-success"></i> <span>Mobil</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>

            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">+62 67634722</span>
                    </div>
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href='/'>SewaYuk</a>
...
<!-- END nav -->
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/bg_a.png');">
      <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-left">
            <div class="col-md-12 heading-section text-left mb-4 ftco-animate">
             Sewa Yuk  berdiri sejak 2018, memiliki pengalaman yang terus dijalani selama bertahun-tahun, memiliki berbagai macam unit kendaraan yang siap melayani kebutuhan rental mobil Anda di Jakarta.</p>

            <p>Sewa Yuk memiliki layanan rental atau sewa mobil untuk berbagai kebutuhan wisata, bisnis dan event. layanan sewa harian dan sewa bulanan, lepas kunci, carteran luar & dalam kota. drop / PP. Juga tersedia layanan sewa mobil khusus wedding dengan pelayanan pengemudi yang handal dan profesional serta berpengalaman.</p>
            </div>
        </div>
    </div>

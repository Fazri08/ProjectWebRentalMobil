	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a href='shop' class="nav-link">Dafar Mobil</a></li>
	          <li class="nav-item"><a href='about' class="nav-link">Syarat & Ketentuan</a></li>
	          <li class="nav-item"><a href='blog' class="nav-link">About</a></li>
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> Jl. Inpres No. 13&14 Kav.27A, Kedoya Utara - Kebon Jeruk, Kota Jakarta Barat, DKI Jakarta 11520</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://1234567920">+62 67634722</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:sewayuk@gmail.com">sewayuk@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website</span> <a href="#">www.sewayuk.com</a></p>
	          </div>
          </div>
        </div>
